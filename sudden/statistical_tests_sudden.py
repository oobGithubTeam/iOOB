...
# create results.csv
result_recall = np.genfromtxt("sudden_recall.csv", delimiter=",")
result_specificity = np.genfromtxt("sudden_specificity.csv", delimiter=",")
result_bac = np.genfromtxt("sudden_bac.csv", delimiter=",")
